...
const LabTestPage = () => {
  ...
  // ✅ Fetch from Firestore 'lab_tests' collection
  useEffect(() => {
    fetchCollection('lab_tests')
    ...
    <div className="min-h-screen bg-gradient-to-br from-teal-50 to-cyan-50">
      ...
      <div className="container mx-auto px-6 py-8">
        ...
        <div className="bg-gradient-to-r from-teal-500 to-cyan-600 rounded-2xl p-6 text-white mb-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            {[['NABL', 'Accredited Labs'], ['Home', 'Sample Collection'], ['24hrs', 'Quick Reports'], ['Safe', '& Hygienic']].map(
              ([title, sub]) => (
                <div key={title}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3">
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-xl font-semibold">{filteredTests.length} tests available</h2>
      ...
      {selectedTest && (
        <LabTestBookingModal
          ...
          onClose={() => { setIsBookingModalOpen(false); setSelectedTest(null); }}
        />
      )}
    </div>
  );
