...
// Changed: import supabase → import fetchCollection from firebaseClient
...
const StorePage = () => {
  ...
  // ✅ Fetch from Firestore 'medicine_store_new' collection
  useEffect(() => {
    fetchCollection('medicine_store_new')
      ...
      <div className="container mx-auto px-6 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-8 bg-white rounded-2xl shadow-sm p-6">
          ...
          <div className="lg:col-span-3">
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-xl font-semibold">{filteredMedicines.length} medicines found</h2>
              <select
                value={sortBy}
                    ...
                    >
                      <Card className="group hover:shadow-xl transition-all duration-300 overflow-hidden rounded-2xl flex flex-col h-full">
                        <div className="relative bg-gradient-to-br from-blue-400/30 to-green-300/30 p-6 text-center h-36 flex items-center justify-center">
                          ...
                          >
                            <Heart className={`w-5 h-5 ${inWishlist ? 'text-red-500 fill-current' : 'text-gray-500'}`} />
                          </button>
                        </div>
                        ...
                        <CardContent className="p-4 flex flex-col justify-between flex-grow">
                          <div>
                            ...
                            <div className="flex items-center justify-between mb-3">
                              ...
                              <span className="text-sm text-green-600 font-medium">{medicine.in_stock} in stock</span>
                            </div>
                          ...
                          <div className="flex gap-2 mt-2">
                            ...
                            <Button variant="outline" size="sm" className="px-3" onClick={() => handleViewMedicine(medicine)}>
